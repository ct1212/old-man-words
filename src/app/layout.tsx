...
export const metadata: Metadata = {
  title: "Old Man Words | Things Your Grandpa Actually Says",
  description:
    "A collection of old-timey phrases, sayings, and words that only old men use. Back in my day, we had real vocabulary.",
  openGraph: {
    title: "Old Man Words",
    description: "Things Your Grandpa Actually Says",
  },
};
    ...
    <html lang="en">
      ...
      >
        ...
        <footer className="border-t-2 border-accent-light bg-card-bg px-6 py-8 text-center text-sm text-foreground/50">
          <p>
            &copy; {new Date().getFullYear()} Old Man Words &mdash; Made with
